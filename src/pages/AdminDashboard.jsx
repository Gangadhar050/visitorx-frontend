...
const fetchDashboardData = async () => {
  try {
    ...
    // show loading only if table is empty
  ...
  const handlePhotoView = (photoSrc, visitorName) => {
    if (!photoSrc) return;
                      ...
                      <td style={{ padding: "8px 16px", verticalAlign: "middle" }}>
                        {photoSrc ? (
                          <img
                            ...
                            onClick={() => handlePhotoView(photoSrc, visitor.name)}
                            style={{
                              width: "44px",
                              height: "44px",
                              borderRadius: "50%",
        ...
        >
          ...
          >
            ...
            <img
              ...
              alt={`${selectedPhoto.name}'s full photo`}
              style={photoModalImageStyle}
            />

            <div style={photoModalNameStyle}>
              {selectedPhoto.name}
            </div>
          </div>
        </div>
...
const photoModalCloseButtonStyle = {
  position: "absolute",
  top: "10px",
  right: "12px",
  width: "34px",
